/* ALÈ · Roger · animacions d'exercicis retirades temporalment.
   El bundle de Roger està compilat i conté el reproductor intern. Aquesta capa
   n'elimina la presentació i pausa qualsevol reproductor que React arribi a muntar,
   sense tocar la prescripció, el registre ni la lògica de sessió. */
(() => {
  'use strict';
